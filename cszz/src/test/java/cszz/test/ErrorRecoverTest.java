...
public class ErrorRecoverTest {
    ...
    public void testCode(String code){
        CszzParser parser = new CszzParser(TokenStreamFactory.createTokenStream(code));
        parser.setErrorHandler(new DefaultErrorStrategy(){
            ...
            public void recover(Parser recognizer, RecognitionException e) {
                ...
                String excTks = exceptedTokens.toString(CszzLexer.VOCABULARY);
...
//                if(exceptedTokens.contains(CszzLexer.SEMI)){
