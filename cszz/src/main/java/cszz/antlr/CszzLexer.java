// Generated from CszzLexer.g4 by ANTLR 4.5.1
package cszz.antlr;
...
public class CszzLexer extends Lexer {
	...
	public CszzLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "CszzLexer.g4"; }
	...
	public static boolean getLexer(String str) {
		List<String> list = Arrays.asList(_LITERAL_NAMES);
	...
	public static String[] getLexerStringList() {
		return keywords;
	}
}
