...
public class Compiler {
    ...
    private final static String APP_NAME = "cszz";
    ...
    public boolean compile(String[] args) throws ParseException, IOException {
        ...
        if(cli.hasOption("gui")){
            ...
            if (cli.hasOption("s")) {
                ...
                fsc.addCszzAndJavaSourceDir(new File(srcPath));
            }
            if (cli.hasOption("o")) {
            ...
            for(String s:srcs){
                ...
                if(srcFile.isDirectory()){
                    fsc.addCszzAndJavaSourceDir(srcFile);
                }else{
                    //TODO here should be currenDir?
                    fsc.addCszzOrJavaSource(currentDir , srcFile);
                }
            }
            hasError = false;
            fsc.compile();
    ...
    public boolean run(CommandLine cli){
        ...
        CszzClassLoader kcl = new CszzClassLoader();
