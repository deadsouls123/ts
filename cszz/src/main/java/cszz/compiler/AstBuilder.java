...
import cszz.antlr.CszzParser.BlockStmtContext;
import cszz.antlr.CszzParser.BreakStatContext;
import cszz.antlr.CszzParser.CastExprContext;
import cszz.antlr.CszzParser.ClassBodyContext;
import cszz.antlr.CszzParser.CompilationUnitContext;
import cszz.antlr.CszzParser.ContinueStatContext;
import cszz.antlr.CszzParser.DoWhileStatContext;
import cszz.antlr.CszzParser.AssignExprContext;
import cszz.antlr.CszzParser.GetArrayElementExprContext;
import cszz.antlr.CszzParser.GetFieldExprContext;
import cszz.antlr.CszzParser.IdentifierExprContext;
import cszz.antlr.CszzParser.InvokeExprContext;
import cszz.antlr.CszzParser.LiteralExprContext;
import cszz.antlr.CszzParser.MemberInvocationExprContext;
import cszz.antlr.CszzParser.BinaryExprContext;
import cszz.antlr.CszzParser.ParenExprContext;
import cszz.antlr.CszzParser.SelfRefExprContext;
import cszz.antlr.CszzParser.ExprStatContext;
import cszz.antlr.CszzParser.ExpressionContext;
import cszz.antlr.CszzParser.ExpressionsContext;
import cszz.antlr.CszzParser.FieldDeclContext;
import cszz.antlr.CszzParser.ForStatContext;
import cszz.antlr.CszzParser.IfStatContext;
import cszz.antlr.CszzParser.ImportDeclContext;
import cszz.antlr.CszzParser.LiteralContext;
import cszz.antlr.CszzParser.MethodDeclContext;
import cszz.antlr.CszzParser.NewExprContext;
import cszz.antlr.CszzParser.QualifiedNameContext;
import cszz.antlr.CszzParser.ReturnStatContext;
import cszz.antlr.CszzParser.StatContext;
import cszz.antlr.CszzParser.TryStatContext;
import cszz.antlr.CszzParser.TypeContext;
import cszz.antlr.CszzParser.VarDeclContext;
import cszz.antlr.CszzParser.VarDeclStatContext;
import cszz.antlr.CszzParser.VarModifierContext;
import cszz.antlr.CszzParser.WhileStatContext;
import cszz.core.VarTable;
import javax.annotation.Nullable;
import cszz.antlr.CszzLexer;
import cszz.antlr.CszzParser.LocalVarDeclContext;
import cszz.antlr.CszzParser.UnaryExprContext;
import cszz.antlr.CszzParserVisitor;
...
public class AstBuilder extends AbstractParseTreeVisitor implements CszzParserVisitor {
    ...
    @Override
    public Object visitEmptyStat(CszzParser.EmptyStatContext ctx) {
    ...
    public AstBuilder(@Nonnull CompilationUnit compilationUnit, @Nonnull CszzParser parser) {
    ...
    @Nullable
    protected ObjectType parseClassType(CszzParser.ClassTypeContext ctx){
        ...
        if(clzDeclaredGenericTypes!=null && clzDeclaredGenericTypes.length>0){
            ...
            List<CszzParser.ParameterizedElementTypeContext> parameterTypes = ctx.parameterTypes;
    ...
    protected Type parseType(TypeContext ctx) {
        CszzParser.ClassTypeContext ct = ctx.classType();
        CszzParser.PrimitiveTypeContext pt = ctx.primitiveType();
        if(ct!=null){
    ...
    @Override
    public ThrowStmt visitThrowStat(CszzParser.ThrowStatContext ctx) {
    ...
    @Override
    public MultiStmtExpr visitMapExpr(CszzParser.MapExprContext ctx) {
    ...
    @Override
    public ExprNode visitNewArrayExpr(CszzParser.NewArrayExprContext ctx) {
    ...
    @Override
    public AstNode visitQuestionExpr(CszzParser.QuestionExprContext ctx) {
        List<Statement> stmts = new LinkedList<>();
    ...
    @Override
    public AstNode visitPostIfStmt(CszzParser.PostIfStmtContext ctx) {
...
//        }
    ...
    public AstNode visitInvokeExpr(InvokeExprContext ctx) {
        ...
        if(refKey.equals(".")){
            ...
            ClassNode dispatcherAst = getAst("cszz.runtime.dynamic.MethodDispatcher");
    ...
    @Override
    public Object visitPrimitiveType(CszzParser.PrimitiveTypeContext ctx) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public IncrementExpr visitIncExpr(CszzParser.IncExprContext ctx) {
        return getIncrementExpr(ctx.expression(), ctx.op.getText(), false);
    }

    @Override
    public IncrementExpr visitPreIncExpr(CszzParser.PreIncExprContext ctx) {
    ...
    @Override
    public Object visitErrorousStat(CszzParser.ErrorousStatContext ctx) {
        handleSyntaxError("missing ';'", ctx, ctx.start , ctx.stop);
        return null;
    }

    @Override
    public Object visitErrorousMemberExpr(CszzParser.ErrorousMemberExprContext ctx) {
        handleSyntaxError("identifier excepted", ctx, ctx.stop , ctx.stop);
        return null;
    }

    @Override
    public Object visitInstanceofExpr(CszzParser.InstanceofExprContext ctx) {
        ExprNode expr = visitExpression(ctx.expression());
    ...
    protected List<AnnotationNode> getAnnotations(@Nullable List<CszzParser.AnnotationContext> ctxs){
        List<AnnotationNode> list = new LinkedList<>();
        if(ctxs!=null){
            for(CszzParser.AnnotationContext an:ctxs){
    ...
    @Override
    @Nullable
    public AnnotationNode visitAnnotation(CszzParser.AnnotationContext ctx) {
    ...
    @Override
    public Object visitClassType(CszzParser.ClassTypeContext ctx) {
        //see parseClassType
        return null;
    }

    @Override
    public Object visitParameterizedElementType(CszzParser.ParameterizedElementTypeContext ctx) {
        return null;
    }
    
    private Type parseParameterizedElementType(CszzParser.ParameterizedElementTypeContext ctx){
    ...
    @Override
    public Object visitWildcardType(CszzParser.WildcardTypeContext ctx) {
        return null;
    }
    
    private Type parseWildcardType(CszzParser.WildcardTypeContext ctx){
    ...
    @Override
    public Object visitForEachStat(CszzParser.ForEachStatContext ctx) {
    ...
    @Override
    public Object visitArrayExpr(CszzParser.ArrayExprContext ctx) {
        ExprNode[] initExprs;
    ...
    @Override
    public Object visitInterpolationExpr(CszzParser.InterpolationExprContext ctx) {
        ...
        for(int i=0;i<exprs.length;i++){
            ...
            if(c instanceof TerminalNode){
                ...
                String text;
                switch(t){
                    case CszzLexer.InterpolationPreffixString:
                        text = rawText.substring(1,rawText.length()-2);
                        break;
                    case CszzLexer.INTERPOLATION_STRING:
                        text = rawText;
                        break;
                    case CszzLexer.RBRACE:
                    case CszzLexer.INTERPOLATION_END:
                    case CszzLexer.INTERPOLATION_INTERUPT:
    ...
    @Override
    public Object visitBitShiftExpr(CszzParser.BitShiftExprContext ctx) {
        String op;
        Token opStart;
        if(ctx.left!=null){
            op = "<<";
